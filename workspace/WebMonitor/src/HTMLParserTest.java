...
public class HTMLParserTest {
	public static void testHtml(String str, String className, String charset) {
		...
		try {
			...
			String result = getPlainText(parser, extractPostBody);
	...
	public static void main(String[] args) throws Exception {
		...
		String url4 = "http://blog.csdn.net/snow_angel_wmy/article/details/4626093";
	...
	public static String extractRegex(String str) {
		...
		System.out.println("The filter answer is " + matcher.group()); // 结果：343
		return result;
	}
}
