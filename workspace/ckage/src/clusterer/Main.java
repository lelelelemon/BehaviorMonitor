...
public class Main {
    ...
    public static void main(String[] args) throws IOException, BadLocationException {
        try {
            ...
            SearchEngine searchEngine =  SearchEngineFactory.createEngine(SearchEngineType.BING);
            
            //Get the search result of the query
            snipArray = searchEngine.search("hello world");
             /** 
